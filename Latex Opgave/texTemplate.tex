...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{totalmalware}
    \captionsetup{width=0.8\textwidth}
...
Lastly we look at hybrid anomaly-based detection, which combine static and dynamic anomaly-based detection. 
